...
# the network will have multiple connected components
# and the start and end will belong to different components
if not path:
    path = []
...
# Assign a different color to the start and end
# and a text label
node_color[start] = Color.red()
node_color[end] = Color.blue()
node_text[start] = str(start)
node_text[end] = str(end)
